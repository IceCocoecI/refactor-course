...
import static com.huawei.data_clumps_ref.personinfo.constant.Constant.LINE_SEPARATOR;
...
class PersonInfoManageTest {
    ...
    void should_get_updatedPersonAddress_when_updateAddress() {
        PersonInfoManage personInfoManage =
            new PersonInfoManage(new Name("SiRui", "Zhang"), Gender.FEMALE,
                new Address("Sichuan", "Chengdu", "someStreet"));
    ...
    void should_get_moveResult_when_moveToAnotherPlace() {
        ...
        final String mailResult =
            personInfoManage.moveToAnotherPlace(new Address("Jiangsu", "Nanjing", "anotherStreet"));
